...
class pluto_5G5_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Pluto 5.5 GHz Test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pluto 5.5 GHz Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "pluto_5G5_test")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(doppler_gain)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'C:\\testfile\\testfile', False)
        ...
        self.connect((self.soapy_plutosdr_source_0, 0), (self.low_pass_filter_0, 0))
    ...
    def set_doppler_gain(self, doppler_gain):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.doppler_gain)




def main(top_block_cls=pluto_5G5_test, options=None):
